                ...
                if (targetSection) {
                    ...
                    if (llmContainer) {
                        ...
                        if (llmTextContainer) {
                            ...
                            // Apply current font size to new content after it's in the DOM
                            ...
                            const newTranscription = llmContent.querySelector('.llm-transcription-only');
                            if (newTranscription && currentSize !== 100) {
                                newTranscription.style.fontSize = `${currentSize}%`;
                            }
                        }
                    }
                }
